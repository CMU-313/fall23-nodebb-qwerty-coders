...
exports.savePerson = undefined;
// instructors.ts
const redis_1 = __importDefault(require('../redis'));

const savePerson = person => __awaiter(undefined, undefined, undefined, function* () {
    // The next line calls a function in a module that has not been updated to TS yet
    // eslint-disable-next-line @typescript-eslint/no-unsafe-member-access, @typescript-eslint/no-unsafe-call
    yield redis_1.default.hmset(person.username, person.email);
});
exports.savePerson = savePerson;
const getPerson = (role, username) => __awaiter(undefined, undefined, undefined, function* () {
    // The next line calls a function in a module that has not been updated to TS yet
